            ...
            <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
                ...
                <form className="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16" onSubmit={handleSubmit}>
                            ...
                            <div className="mt-4">
                                ...
                                <div className="mt-1">
                                    <input
                                        ...
                                        name="email-address"
                                        autoComplete="email"
                                        className="block w-full h-10  text-blackPrimary indent-2 border-gray-200 ouline-none"
                                    />
                                </div>
                            </div>
                        </div>
                                ...
                                <div className="sm:col-span-2">
                                    ...
                                    <div className="mt-1">
                                        <textarea
                                            name="notes"
                                            id="notes"
                                            className="block w-full h-20  text-blackPrimary indent-2 border-gray-200 ouline-none"
                                        />
                                    </div>
                                </div>
                    ...
                    <div className="mt-10 lg:mt-0">
                        ...
                        <div className="mt-4 border border-gray-200 bg-primary shadow-sm">
                            ...
                            <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                <button
                                    type="submit"
                                    className="w-full h-14 bg-white text-blackPrimary text-xl max-sm:h-10 max-sm:text-xl max-[460px]:text-lg max-[360px]:h-9">
                                    Confirm order
                                </button>
                            </div>
                        </div>
